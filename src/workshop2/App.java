...
public class App {
    ...
    private Fraction inputFraction(String name) {
        ...
        System.out.println("Successfully added " + name + ": " + f);
        return f;
    }
    ...
    private void addFractions() {
        if (checkFractionExist()) {
            ...
            System.out.printf("Result: (%s) + (%s) = %s%n", fraction1, fraction2, result);
        }
    }
    ...
    private void printMenu() {
        ...
        System.out.println("3. Add 2 fractions (f1 + f2)");
        System.out.println("4. Subtract 2 fractions (f1 - f2)");
        System.out.println("5. Multiply 2 fractions (f1 * f2)");
        System.out.println("6. Divide 2 fractions (f1 / f2)");
